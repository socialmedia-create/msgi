              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-4 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-gold/30 transition-colors">
                  ...
                  <div>
                    ...
                    <a href="tel:+919841739924" className="info-val text-white font-medium hover:text-gold transition-colors text-sm md:text-base font-mono">
                      +91 98417 39924 / +91 99402 44685
                    </a>
