document.addEventListener("DOMContentLoaded", function () {
  ...
  if (calendarEl) {
    calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      events: {
        googleCalendarId:
          "9929ff772c36b25ac7cc532ff3dd094b7fe502776c9932d689e8b026d6e426ba@group.calendar.google.com"
      },
  ...
  document.getElementById("performance-tab").addEventListener("shown.bs.tab", function () {
    if (!calendarInitialized) {
      ...
      // if already rendered, just update size in case of layout shift
      calendar.updateSize();
    }
  });
